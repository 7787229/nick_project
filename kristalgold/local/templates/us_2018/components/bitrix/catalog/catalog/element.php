...
<div class='row'>
	<div class='<?=($isSidebar ? 'col-md-9 col-sm-8' : 'col-xs-12')?>'>
		...
		$componentElementParams = array(
			...
			'PRODUCT_INFO_AND_PAYMENT_BLOCK_ORDER' => (isset($arParams['DETAIL_PRODUCT_INFO_AND_PAYMENT_BLOCK_ORDER']) ? $arParams['DETAIL_PRODUCT_INFO_AND_PAYMENT_BLOCK_ORDER'] : ''),
			'USE_NO_SIZE' => $arParams['USE_NO_SIZE'],
			'USE_ORDER_ONE_CLICK' => $arParams['USE_ORDER_ONE_CLICK'],
						...
						<div class="">
							<?$APPLICATION->IncludeComponent(
								...
								Array(
									...
									"MODERATION_GROUP" => $arParams['REVIEW_MODERATION_GROUP'],
									"ELEMENT_ID" => $elementId,
									"COUNT_PAGE"=> $arParams['MESSAGES_PER_PAGE'],
								)
							);?>
						</div>
					</div>
