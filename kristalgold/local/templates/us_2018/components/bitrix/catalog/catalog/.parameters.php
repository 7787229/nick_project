...
if (isset($arCurrentValues['IBLOCK_ID']) && (int)$arCurrentValues['IBLOCK_ID'] > 0)
{
	...
	{
		$arTemplateParameters['LIST_VOTE_DISPLAY_AS_RATING'] = array(
			'PARENT' => 'LIST_SETTINGS',
	...
	$arTemplateParameters['LIST_PRODUCT_BLOCKS_ORDER'] = array(
		...
		'JS_DATA' => Json::encode(array(
			...
			'rating' => GetMessage('CP_BC_TPL_RATING')
		)),
...
/* ugrm@uvelirsoft.ru */
$arTemplateParameters['USE_ORDER_ONE_CLICK'] = array(
	'PARENT' => 'DETAIL_SETTINGS',
	'NAME' => GetMessage('use_order_one_click'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'Y'
);
$arTemplateParameters['USE_NO_SIZE'] = array(
	'PARENT' => 'DETAIL_SETTINGS',
	'NAME' => GetMessage('use_no_size'),
	'TYPE' => 'CHECKBOX',
	'DEFAULT' => 'Y'
);
$arTemplateParameters['DETAIL_PRODUCT_INFO_AND_PAYMENT_BLOCK_ORDER'] = array(
	'PARENT' => 'DETAIL_SETTINGS',
	'NAME' => GetMessage('CP_BC_TPL_PRODUCT_INFO_AND_PAYMENT_BLOCK_ORDER'),
	'TYPE' => 'CUSTOM',
	...
	'JS_DATA' => Json::encode(array(
		...
		'compare' => GetMessage('compare')
	)),
	'DEFAULT' => 'price,priceRanges,sku,props,quantityLimit,quantity,buttons,compare'
);
/* ugrm@uvelirsoft.ru */
/*
...
/* REVIEW_SETTINGS */
	...
	$db_iblock = CIBlock::GetList(
	    array("SORT"=>"ASC"),
	    array(
	        "TYPE" => ($arCurrentValues["REVIEW_IBLOCK_TYPE"]!= "-" ? $arCurrentValues["REVIEW_IBLOCK_TYPE"]: "")
	    )
	);
	...
	$arTemplateParameters["REVIEW_MODERATION_GROUP"] = array(
		"PARENT" => "REVIEW_SETTINGS",
