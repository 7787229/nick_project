...
$MESS["CP_BC_TPL_PRODUCT_INFO_AND_PAYMENT_BLOCK_ORDER"] = "Порядок отображения блоков информации о товаре и покупки товара";
...
$MESS["CP_BC_TPL_RATING"] = "Ретинг";


$MESS["order_one_click"] = "Заказ в 1 клик";
$MESS["no_size"] = "Нет моего размера";

$MESS["use_order_one_click"] = "Показывать форму 'Заказ в 1 клик'";
$MESS["use_no_size"] = "Показывать форму 'Нет моего размера'";
