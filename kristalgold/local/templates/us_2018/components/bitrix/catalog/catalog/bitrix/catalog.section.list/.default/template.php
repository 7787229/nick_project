...
if ( $arParams["SEO_FILTER"]["CONTENT_VALUE"]) {
	if ( $arParams["SEO_FILTER"]["CONTENT_VALUE"]["TEXT"]) {
		echo '<div class="row"><p>'.$arParams["SEO_FILTER"]["CONTENT_VALUE"]["TEXT"].'</p></div>';
	} else {
		echo '<div class="row">'.$arParams["SEO_FILTER"]["CONTENT_VALUE"]["HTML"].'</div>';
	}

}

if (0 < $arResult["SECTIONS_COUNT"] && !$hideSections)
{
?>
