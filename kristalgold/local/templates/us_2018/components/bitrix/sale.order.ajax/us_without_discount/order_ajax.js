	...
	BX.Sale.OrderAjaxComponent = {
		...
		initOptions: function()
		{
			...
			if (this.result.TOTAL)
			{
				...
				this.options.showPriceWithoutDiscount = false;//ruri@uvelirsoft.ru
				this.options.showDiscountPrice = false; //ruri@uvelirsoft.ru
		...
		editTotalBlock: function()
		{
			...
			if (this.result.DELIVERY.length && !this.hideDelivery)
			{
