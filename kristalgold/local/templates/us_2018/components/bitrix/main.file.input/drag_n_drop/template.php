...
<div id="file-selectdialog-<?=$uid?>" class="file-selectdialog" style="display:none;">
	...
	<div class="file-extended">
		...
		<div class="file-selector">
			...
			<span class="file-uploader"><span class="file-but-text"><?=GetMessage('BFDND_SELECT_EXIST');?></span><input class="file-fileUploader <?=$addClass?>" id="file-fileUploader2-<?=$uid?>" type="file" multiple='multiple' size='1' /></span>
