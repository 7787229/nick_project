	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-6 col-sm-12">
											...
											<div class="product-item-detail-info-container" data-entity="sku-line-block">
												...
												<div class="product-item-scu-container">
													<div class="product-item-scu-block">
														<div class="product-item-scu-list<?=($dropdown ? " wrapper-dropdown" : "")?>">
				...
				<div class="product-item-detail-info-section">
					<div class="store-list-title">Наличие в магазинах <div class="btn btn-link" id="all_size_link">показать все размеры</div></div>
...
<script type="text/javascript">
	...
	function toggleShopRow(athis,id) {
		$('.shop-list-offers').data('shop',id).each(function( index ) {
			if ($(athis).hasClass("fa-chevron-down") ){
		...
		if ($(athis).hasClass("fa-chevron-down") ){
			$(athis).removeClass('fa-chevron-down');
			$(athis).addClass('fa-chevron-up');
		} else {
			$(athis).removeClass('fa-chevron-up');
			$(athis).addClass('fa-chevron-down');
		}
	}
</script>
<?
