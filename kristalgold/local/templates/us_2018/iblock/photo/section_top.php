...
if (CModule::IncludeModule("iblock")):
 ...
 $arFilter = Array('IBLOCK_ID'=>$IBLOCK_ID, 'GLOBAL_ACTIVE'=>'Y');
  $db_list = CIBlockSection::GetList(Array($by=>$order), $arFilter, true);
		...
		?>
		<center><h1><?echo $SECTION_NAME;?></h1></center>
		<table cellpadding="5" cellspacing="0" border=0 align="center"  style="border-top: 1px solid #C8C8C8; border-left: 1px solid #C8C8C8; ">	
			<tr valign="middle">
				<?
				$n=1;
				$cell = 0;
			while($ar_result = $db_list->GetNext()):
					...
					$arrFilter_EL["SECTION_ID"] = $ar_result["ID"];
						$rsElements = GetIBlockElementListEx($IBLOCK_TYPE, $IBLOCK_ID, false, array("RAND"), false, $arrFilter_EL, $arSelect);
				...
				?>
				<td width="127" align="center" style="border-right: 1px solid #C8C8C8; border-bottom: 1px solid #C8C8C8; " >
					<table cellpadding="2" cellspacing="0" border="0">
						<tr>
						  <td align="center" valign="top"><a href="?SECTION_ID=<?=$ar_result["ID"]?>"> <?echo CFile::ShowImage($image1,  145 ,97, "style='border-color:#000000;' hspace='0' vspace='0' border='1' title='".$arElement["NAME"]."'");?></a></td>
						</tr>
					
						<tr>
						
							<td align="center" valign="top"> <a href="?SECTION_ID=<?=$ar_result["ID"]?>"><?=$ar_result["NAME"]?></a></td>
						</tr> 
			  </table></td>
					<?
