            ...
            <div class="col-md-12">
                ...
                foreach ($arResult["SLIDER"] as $keySlider => $valueSlider) {
                    ...
                    <div class="item item_kart">
                        <a href="<?=$valueSlider["URL"]?>" class="inner-item">                   
							...
							*/?>
                                ...
                                if(intval($valueNew['DISCOUNT_PERCENT'])>0){
                                    ?>  
                                        ...
                                        <span class="price sale-new"><?=number_format(round($valueNew["PRICE"] - $valueNew["PRICE"]*intval($valueNew['DISCOUNT_PERCENT'])/100), 0, '.', ' ' );?></span>
                                    <?
                                    }else{
                                    ?>
