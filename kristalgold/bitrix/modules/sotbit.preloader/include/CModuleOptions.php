...
class CModuleOptions
{
    ...
    {   
        ...
        switch ($type)
        {
            case "left-top":
                ...
                break;
            case "center-top":
                $style = "position:fixed!important;left:50%!important;top:0%!important;margin-left:-".$w."!important;";
                break;
            case "right-top":
            ...
            case "left-middle":
                $style = "position:fixed!important;left:0%!important;top:50%!important;margin-top:-".$h."!important;";
                break;
            case "center-middle":
                $style = "position:fixed!important;left:50%!important;top:50%!important;margin-left:-".$w."!important;margin-top:-".$h."!important;";
                break;
            case "right-middle":
                $style = "position:fixed!important;left:auto!important;right:0%!important;top:50%!important;margin-top:-".$h."!important;";
                break;

            case "left-bottom":
                $style = "position:fixed!important;left:0%!important;top:auto!important;bottom:0%!important;margin-top:-".$h."!important;";
                break;
            case "center-bottom":
                $style = "position:fixed!important;left:50%!important;top:auto!important;bottom:0%!important;margin-left:-".$w."!important;";
                break;
            case "right-bottom":
    ...
    {   $module_id = "sotbit.preloader";
        ...
        if($_REQUEST["ACTIVE"]!="Y") unlink($_SERVER["DOCUMENT_ROOT"].BX_ROOT."/themes/.default/".$module_id.".style.css");
            ...
            {
                $arParams[$param] = trim(COption::GetOptionString($module_id, $param));
            }
            $style = "div[id^=wait_]{";
            ...
            if($arParams["WIDTH"] && $arParams["HEIGHT"]){
                if(strpos($arParams["WIDTH"], "%")===false)
                {
                    $style.="width:".$arParams["WIDTH"]."px!important;";    
                }else{//die();
                    $style.="width:".$arParams["WIDTH"]."!important;";    
                }
                
                if(strpos($arParams["HEIGHT"], "%")===false)
                {
                    $style.="height:".$arParams["HEIGHT"]."px!important;";    
                }else{
                    $style.="height:".$arParams["HEIGHT"]."!important;";    
                }
            }else{
